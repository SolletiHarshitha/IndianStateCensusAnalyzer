...
namespace IndianStatesCensusAnalyzerTests
{
    public class Tests
    {
        ...
        string wrongCensusPath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\IndiaStateData.csv";
        string wrongTypeStateCensusPath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\IndiaStateCensusData.txt";
        string wrongHeaderStateCensusPath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\WrongIndiaStateCensusData.csv";
        string delimiterStateCensusPath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\DelimiterStateCensusData.csv";
        ...
        string wrongCodePath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\IndiaStateCodeData.csv";
        string wrongTypeStateCodePath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\IndiaStateCode.txt";
        string wrongHeaderStateCodePath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\WrongIndiaStateCode.csv";
        string delimiterStateCodePath = @"D:\tvstraining\IndianStatesCensusAnalyzer\IndianStatesCensusAnalyzer\CSVFiles\DelimiterStateCode.csv";
